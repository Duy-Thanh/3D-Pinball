...
void SpaceCadetPinballJNI::notifyGameState(int state) {
    ...
    if (clazz == nullptr) clazz = env->FindClass("com/cyberdaystudio/games/spacecadetpinball/JNIEntryPoint");
...
Java_com_cyberdaystudio_games_spacecadetpinball_MainActivity_initNative(JNIEnv *env, jobject thiz,
        jstring data_path) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_cyberdaystudio_games_spacecadetpinball_MainActivity_setVolume(JNIEnv *env, jobject thiz, jint vol) {
    Sound::SetVolume(vol);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_cyberdaystudio_games_spacecadetpinball_MainActivity_putString(JNIEnv *env, jobject thiz, jint id, jstring str) {
...
Java_com_cyberdaystudio_games_spacecadetpinball_MainActivity_checkCheatsUsed(JNIEnv *env, jobject thiz) {
